...
\end{eqnarray*} 
\jd{Not sure what are we going to say here. We can say that this function is nonlinear, nonconcave, and we can use a global optimization solver to find the minimum}
