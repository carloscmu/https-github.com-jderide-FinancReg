...
%\begin{eqnarray*}
%\var_{\bar p}\left(\sum_{i=1}^N \pi_i(r^*_i(x_i)(1-\epsilon_i))\right)&=&\sum_i \var(\pi_i(r^*_i(x_i)(1-\epsilon_i))+2\sum_{j<i}\cov(\pi_i(r^*_i(x_i)(1-\epsilon_i)),\pi_j(r^*_j(x_j)(1-\epsilon_j))\\
%\end{eqnarray*}
